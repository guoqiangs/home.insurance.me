...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="form1" runat="server">
        <div class="f-wrap01">
            ...
            <div id="productId_10067" class="B-ui-table-ext01" style="padding: 0; display:none;">
            ...
            <div id="productId_10068" class="B-ui-table-ext01" style="padding: 0; display:none;">
                <table class="B-ui-table B-ui-table-thead-center B-ui-table-tbody-center B-ui-table-ext01-thead-fef8f2">
                    <thead>
                        <tr>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="B-ui-table-ext">500,000.00</div>
                            </td>
                        </tr>
                        <tr>
                            <td>
            ...
            <div id="productId_10069" class="B-ui-table-ext01" style="padding: 0; display:none;">
                <table class="B-ui-table B-ui-table-thead-center B-ui-table-tbody-center B-ui-table-ext01-thead-fef8f2">
                    <thead>
                        <tr>
                            <th>
            ...
            <dl class="f-text01 clearfix">
                <dt>证件号码：</dt>
                <dd><%=viewModel.PolicyHolderIdentifyNumber %></dd>
                <dt>手机号码：</dt>
            ...
            <div class="f-text02">保费：<%=viewModel.OrderAmount %>元</div>
            <div class="f-text03">
                投保人声明：<br>
                &nbsp;&nbsp;&nbsp;&nbsp;保险人已将投保险种对应的保险条款（包括责任免除部分）向本人作了明确说明，本人已充分理解，上述所填写的内容均属事实，同意签订本保险合同。
           
                <br>
                &nbsp;&nbsp;&nbsp;&nbsp;投保人签字（盖章)：<%=viewModel.PolicyHolderName %>  <%=DateTime.Now.ToShortDateString() %>
            ...
            <asp:Button ID="NextBtn" Text="下一步" CssClass="f-submit01" OnClick="NextBtn_Click" runat="server" />
        </div>
    </form>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            switch (productId) {
                case "10067": $("#productId_10067").show(); break;
                case "10068": $("#productId_10068").show(); break;
                case "10069": $("#productId_10068").show(); break;
            }
        });
