  ...
  <%--             <div class="f-form">
         ...
         <div class="f-form">
            ...
            <div class="f-form">
                <label class="f-form-label">&nbsp;</label>
                <span class="f-form-content">
                    <%--<input type="submit" value="提交" class="f-form-submit">--%>
                    <asp:Button ID="btnRegister" runat="server" Text="提交" CssClass="f-form-submit" OnClick="btnRegister_Click" OnClientClick="return checkPage ();" />
                </span>
            </div>
        </form>
    </div>
    ...
    <script type="text/javascript">
        ...
        $("input[data-flag='phone']").blur(function () {
            ...
            if (mobile.length == 11) {
                ...
                $.getJSON(domain + url + parameters, function (json) {
                    if (json == 0) {
                        $("#mobile-tips").text("手机号码未注册，请核实手机号！");
                        $("#mobile-tips").fadeIn();
                    }
                    else{
